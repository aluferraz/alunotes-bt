...
Maintains the original deep-ink aesthetic. Focus on high-contrast neon accents against the `#0b0f10` inverse surface.
...
* **Dark Mode:** Uses **Inter** for a sharp, technical, and modern digital feel.
* **Light Mode:** Uses **Manrope** for an organic, geometric, and high-end editorial feel.

### The Scale
| Level | Font | Size | Weight / Usage |
| :--- | :--- | :--- | :--- |
| `display-lg` | Manrope/Inter | 3.5rem | Negative letter-spacing (-0.02em). Use for Hero headlines. |
| `headline-md` | Manrope/Inter | 1.75rem | High-contrast section headers. |
| `title-sm` | Manrope/Inter | 1.0rem | Bold. For card headers and navigational anchors. |
| `body-lg` | Manrope/Inter | 1.0rem | Regular. Optimized for long-form reading. |
| `label-md` | Manrope/Inter | 0.75rem | Uppercase with +0.05em tracking for utility labels. |
...
* **Do** use "Manrope" for all text in light mode to emphasize the geometric, premium feel.
